...
INSERT INTO snapshots (id, snapshot, descr)
       VALUES ('1', '181', 'FY13 School Budgets May 24, 2012');

INSERT INTO snapshots (id, snapshot, descr)
       VALUES ('2', '161', 'FY12 School Budgets May 27, 2011');

INSERT INTO snapshots (id, snapshot, descr)
       VALUES ('3', '141', 'FY11 School Budgets  April 22,2010');

INSERT INTO snapshots (id, snapshot, descr)
       VALUES ('4', '121', 'FY10 School Budgets February 1, 2010');

INSERT INTO snapshots (id, snapshot, descr)
       VALUES ('5', '101', 'FY10 School Budgets April 1 2009');

INSERT INTO snapshots (id, snapshot, descr)
       VALUES ('6', '61', 'FY09 School Budgets (February 2009)');
